...
export const ARTICLES = [
  ...
  },
  {
    ...
    body: [
      ...
      { note: "Delivery status (queued, sent, delivered) is simulated in this preview build \u2014 there is no real SMS/WhatsApp/email gateway wired up yet. The message queue, template system, and channel selection are all real; only the actual carrier delivery is not." },
    ],
  ...
  },
  {
    ...
    body: [
      { p: "Administration \u2192 Users & roles is where a hospital's own administrator creates every other staff account. Adding someone here means setting their actual sign-in email and password directly \u2014 there is no automated invite email in this build, so share the credentials with the new staff member yourself." },
      ...
      { note: "This is a best-effort browser fingerprint, not a hardware-verified one \u2014 useful for noticing an unfamiliar sign-in, not a hard security boundary. A production deployment would pair this with server-side signals this preview build has no server to provide." },
    ],
