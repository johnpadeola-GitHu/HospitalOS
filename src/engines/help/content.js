...
export const ARTICLES = [
  ...
  },
  {
    ...
    body: [
      { p: "From the sign-in screen, a hospital with an activation code clicks \u201cHave an activation code?\u201d to run an 8-step registration wizard. Anyone can still start a no-commitment 7-day demo (\u201cTry free for 7 days\u201d) without a code \u2014 the demo and full registration are deliberately separate paths." },
      { h: "The 8 steps" },
      { table: { head: ["#", "Step", "What happens"], rows: [
        ["1", "Activation code", "Validated immediately \u2014 shows the tenant name and plan the code was issued for, before anything else is asked"],
        ["2", "Hospital identity", "Name, type, address"],
        ["3", "Administrator account", "Name, email, and a real password the admin chooses \u2014 not a temporary one"],
        ["4", "Facility details", "Bed capacity, number of centres, which departments to enable"],
        ["5", "Staff roles", "Which roles you'll be onboarding \u2014 pre-shapes Users & roles, nothing is locked in"],
        ["6", "Branding", "Logo, phone, registration number \u2014 all editable later in Settings"],
        ["7", "Plan confirmation", "Read-only \u2014 the plan was set when the code was issued, not chosen here"],
