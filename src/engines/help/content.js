...
export const ARTICLES = [
  ...
  },
  {
    ...
    lead: "AgoroX support can switch between the hospital and the platform \u2014 two genuinely separate views behind one account.",
    body: [
      { p: "Only support@agorox.africa carries platform admin rights. That account, and only that account, sees a compact Hospital / Platform toggle switch in the topbar \u2014 every other account, including a hospital's own Super Admin, never sees it at all." },
      { h: "What the Platform view actually contains" },
      { p: "Switching to Platform mode replaces the entire hospital-facing screen with AgoroX's own vendor-side tools: every tenant hospital on the platform, settlement and usage figures, activation code issuance, and platform-level service health \u2014 none of which any hospital's own staff, including their Super Admin, can see." },
      { warn: "Entering a tenant's own working view from the Platform side (to help troubleshoot, for example) means any change made there is a real change to that hospital's real data \u2014 there is no separate sandbox. This is a genuine operational responsibility, not a casual browsing mode." },
      { p: "The toggle itself only ever appears for the platform admin account \u2014 it is not merely hidden by styling for everyone else; ordinary tenant accounts have no code path that could reach it." },
    ],
    related: ["onboarding", "activation-codes", "settlement"],
  },
