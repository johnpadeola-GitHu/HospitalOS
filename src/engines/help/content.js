  ...
  },
  {
    ...
    body: [
      ...
      { table: { head: ["#", "Step", "What happens"], rows: [
        ...
        ["2", "Hospital identity", "Name, type, address"],
        ...
        ["7", "Review & confirm", "Full summary with an Edit link back to any step; submitting is the only point anything is actually written"],
      ] } },
      { warn: "Nothing is written to the tenant or account records until Step 7's submit \u2014 steps 1 through 6 are pure local state. A refresh mid-wizard resumes exactly where you left off; the wizard saves its progress to the browser after every change." },
