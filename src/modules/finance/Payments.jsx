...
const methodPill = { fontSize: 11, fontWeight: 500, color: "var(--ink)", background: "var(--surface)", padding: "2px 9px", borderRadius: 0 };
const settledPill = { fontSize: 11, fontWeight: 500, color: "var(--good)", background: "var(--good-bg)", padding: "2px 9px", borderRadius: 0 };
const pendingPill = { fontSize: 11, fontWeight: 500, color: "var(--warn)", background: "var(--warn-bg)", padding: "2px 9px", borderRadius: 0 };
...
const sessionDot = { width: 8, height: 8, borderRadius: 0, background: "var(--good)", flexShrink: 0 };
