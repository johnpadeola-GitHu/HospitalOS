...
const chainBar = { display: "flex", alignItems: "center", gap: 9, borderRadius: 0, padding: "10px 14px", fontSize: 12.5, marginBottom: 16 };
const chainOk = { background: "var(--good-bg)", color: "var(--good)" };
const chainBad = { background: "var(--bad-bg)", color: "var(--bad)" };
const note = { display: "flex", gap: 8, marginTop: 14, background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 0, padding: "10px 13px", fontSize: 11.5, color: "var(--muted)", lineHeight: 1.6 };
