    ...
    <div>
      <div style={header}>
        <div>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 600, color: "var(--ink-strong)" }}>Oncology</h1>
        </div>
        <Button variant="primary" onClick={() => setShowNew(true)}>+ Register patient</Button>
      </div>
...
const overdueDot = { display: "inline-block", width: 7, height: 7, borderRadius: "50%", background: "#B0281F", marginLeft: 7, verticalAlign: "middle" };
