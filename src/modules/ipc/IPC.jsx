...
const outbreakBanner = { display: "flex", gap: 9, background: "var(--bad-bg)", color: "var(--bad)", fontSize: 12.5, padding: "11px 14px", borderRadius: 0, marginBottom: 16, lineHeight: 1.5 };
