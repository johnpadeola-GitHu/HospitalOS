...
export default function Formulary() {
  ...
  return (
    <div>
      <PageHeader group="Pharmacy" title={<>Formulary &amp; NAFDAC</>} icon="BookMarked" />
...
const input = { width: "100%", font: "inherit", fontSize: 13, padding: "8px 10px", borderRadius: 0, border: "1px solid var(--border-strong)", background: "var(--surface-2)", color: "var(--ink)" };
