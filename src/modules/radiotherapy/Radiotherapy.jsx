...
export default function Radiotherapy() {
  ...
  return (
    <div>
      <div style={header}>
        <div>
          <div style={{ fontSize: 11, color: "var(--muted)" }}>Diagnostics</div>
          <h1 style={{ fontSize: 20, fontWeight: 600, color: "var(--ink-strong)" }}>Radiotherapy</h1>
        </div>
        <Button variant="primary" onClick={() => setShowNew(true)}>+ New course</Button>
      </div>
