...
export default function Radiotherapy() {
  ...
  return (
    <div>
      ...
      {loading ? <div style={{ color: "var(--muted)", fontSize: 13 }}>Loading courses…</div> : rows.length === 0 ? (
        <div style={{ color: "var(--muted)", fontSize: 13, padding: "20px 2px" }}>No radiotherapy courses yet.</div>
      ) : (
