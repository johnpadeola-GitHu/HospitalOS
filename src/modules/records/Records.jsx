...
const noteCard = { background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 0, padding: "11px 13px" };
...
const amendBanner = { display: "flex", gap: 7, background: "var(--warn-bg)", color: "var(--warn)", fontSize: 12, padding: "9px 11px", borderRadius: 0, marginBottom: 14 };
